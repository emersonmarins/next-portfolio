...
export const Header = () => (
  <>
    <div className={stylePortfolio.portfolioTitleContainer}>
      <h2 className={stylePortfolio.portfolioTitle + stylePortfolio.portfolioTitleSpanBefore}>{LouseSoftDesigner[0].header.titleContent}</h2>
      <div className={stylePortfolio.btnRepository}>
        <GitHubLogoIcon className={stylePortfolio.faGithubicon} />
        <span>REPOSITÓRIO</span>
      </div>
    </div>
    <h2 className={stylePortfolio.portfolioTextTitle}>{LouseSoftDesigner[0].header.subTitle}</h2>
  </>
